...
exports["orders_standard"] = [
  ...
  new Field(nanoid(8), "number", "total"),
  new Field(nanoid(8), "number", "amount"),
  new Field(nanoid(8), "number", "quantity"),
]

exports["categories_standard"] = [
  new Field(nanoid(8), "string", "name", 3, 34),
  new Field(nanoid(8), "string", "short_description", 3, 255),
  new Field(nanoid(8), "json-string", "details", 3, 3400),
  new Field(nanoid(8), "string", "description", 3, 3400),
  new Field(nanoid(8), "number", "price", undefined, undefined, true),
]
