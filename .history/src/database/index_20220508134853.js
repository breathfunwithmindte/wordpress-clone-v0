...
module.exports = class Database {
  ...
  async connect () {
    try{
      ...
      const db = await Pdb.create({});
      await $Project.create({database: db._id});

      console.log(await $Project.findOne(), "project");
      console.log(await $Page.findOne(), "Page");
      console.log(await $Pdb.findOne(), "Pdb");
