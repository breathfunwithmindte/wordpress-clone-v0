...
exports["orders_standard"] = [
  ...
  { _id: nanoid(8), name: "quantity", field: "number" },
  { _id: nanoid(8), name: "status", field: "enum-string", enum_arr: "pedding,paid" },
  { _id: nanoid(8), name: "registered", field: "date" },
  { _id: nanoid(8), name: "stages", field: "enum-string", enum_arr: "open,delivering,preparing,closed-success,closed-error" },
]
