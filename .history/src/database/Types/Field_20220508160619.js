module.exports = class Field extends Type {
   ...
   */
    constructor(_id, field, name, default_value, minlength, maxlength, required, lowercase, ref, array, enum_arr)
    {
      ...
      if(lenum_arr) this.enum_arr = lenum_arr;
      ...
      if(
        (this.field !== "enum-string") && (this.enum_arr && this.enum_arr !== "")
      ) throw new Error(this.name + "::Property enum_arr is not necessary for non enum-string field types.")
