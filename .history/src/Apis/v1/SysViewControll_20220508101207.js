...
module.exports = class SysViewControll {
  static use = [
    { md: "get", m: "getPages", mdl: [], t: "json", p: "/api/v1/system/admin/pages/read" },
    { md: "get", m: "getPage",  mdl: [], t: "json", p: "/api/v1/system/admin/pages/read/:name" },
  ];
